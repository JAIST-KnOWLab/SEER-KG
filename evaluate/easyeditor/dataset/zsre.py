...
class ZsreDataset(Dataset):
    ...
    def __init__(self, data_dir: str, size: typing.Optional[int] = None, config=None, *args, **kwargs):
        ...
        if config is not None and hasattr(config, 'tokenizer_name'):
            ...
            # print("tokenizer_name:", tok_name)
            # print("Type:", type(tok_name))
            ...
            tokenizer.pad_token = tokenizer.eos_token # additional
        ...
        subset_size = int(0.0002 * len(data))  # Calculate 20% of total data
        data = random.sample(data, subset_size)  # Randomly select 20%
